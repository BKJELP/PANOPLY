...
tech_interview = Outfit.new(name:"Let's shine as a baby unicorn", description:"You cannot join a unicorn without looking like a unicorn. As simple as that. 100 percent success rate", price:"35", catagory:"startup", image:"https://res.cloudinary.com/willzor/image/upload/v1619721468/Unic_i1k2aq.jpg")
